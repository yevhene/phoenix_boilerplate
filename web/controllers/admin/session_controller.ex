defmodule PhoenixBoilerplate.Admin.SessionController do
  @moduledoc """
  ...
  """
  use PhoenixBoilerplate.Web, :admin_controller

  alias PhoenixBoilerplate.UserFromAuth
  ...
  # We've aliased Guardian.Plug.EnsureAuthenticated in our PhoenixBoilerplate.Web.admin_controller macro
