defmodule PhoenixBoilerplate.Router do
  use PhoenixBoilerplate.Web, :router
  ...
  scope "/auth", PhoenixBoilerplate do
  ...
  scope "/admin", PhoenixBoilerplate.Admin, as: :admin do
  ...
  scope "/api", PhoenixBoilerplate do
